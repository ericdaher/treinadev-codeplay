...
describe 'Admin view lessons' do
  it 'of a course' do
    capaldi = create(:instructor, email: 'peter@capaldi.com')
    ...
    Lesson.create!(name: 'Aula que não será mostrada', duration: 40, description: 'Descrição que não aparece',
                   course: other_course)
  ...
  it 'and view details' do
    ...
    Lesson.create!(name: 'Classes e Objetos I', duration: 0, description: 'Orientação a Objetos em Ruby - Parte I',
                   course: course)
    Lesson.create!(name: 'Monkey Patch', duration: 1, description: 'Uma aula sobre Monkey Patch', course: course)
    Lesson.create!(name: 'Classes e Objetos III', duration: 20,
                   description: 'Orientação a Objetos em Ruby - Parte III', course: course)
